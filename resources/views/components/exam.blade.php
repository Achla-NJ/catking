                ...
                <div class="row">                                
                    ...
                    <div class="col-md-2 cat_{{$item}} {{$display}} ">  
                        <div class="mb-3">    
                            ...
                            <label for="" class="form-label mb-0">Exam Name</label>
                    ...
                    <div class="col-md-2 col-lg cat_{{$item}} {{$display}} disp">
                        <div class="mb-3">
                    ...
                    <div class="col-md-1 col-lg-auto cat_{{$item}} {{$display}} my-auto disp" id="sop_card{{$item}}">
