...
<div class="card">
   <div class="card-body">
      <form class="form-horizontal form-label-left" action="{{route('cat-predictor-process')}}" method="post">
        @csrf
        <input type="hidden" value="{{$user->id}}" name="user_id" id="user_id">
         <h4>CAT Score Calculator - Submit your details to get your expected CAT 2021 Score
         </h4>
         <hr>
         <div class="col-md-6">
            <div class="mb-3">
         ...
         @foreach ($sc_cat_data as $sc_cat_key => $sc_cat)
            ...
            @endphp
         @endforeach
         <h5>Exam Slot<span style="color:red;">*</span></h5>
         <div class="item form-group mb-3">
            <label class=" col-md-3 col-sm-3 col-xs-12" for="manager">Select Your Slot<span style="color:red;">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
         ...
         <h5>Sectional Scores</h5>
         <div class="item form-group mb-3">
            <label class=" col-md-3 col-sm-3 col-xs-12" for="manager">VARC<span style="color:red;">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="cat_varc" class="form-control col-md-7 col-xs-12" name="sc_cat[varc]" placeholder="" type="text" required="" value="{{$varc}}" >
            </div>
         </div>
         <div class="item form-group mb-3">
            <label class=" col-md-3 col-sm-3 col-xs-12" for="manager">DILR<span style="color:red;">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="cat_dilr" class="form-control col-md-7 col-xs-12" name="sc_cat[dilr]" placeholder="" type="text" required="" value="{{$dilr}}" >
            </div>
         </div>
         <div class="item form-group mb-3">
            <label class=" col-md-3 col-sm-3 col-xs-12" for="manager">Quants<span style="color:red;">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
         ...
         <div class="item form-group mb-3">
            <label class=" col-md-3 col-sm-3 col-xs-12" for="manager">CAT Score<span style="color:red;">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
