    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Profile Reviews</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="accordion" id="accordionExample">
                @php
                $count=0;
                    $review = App\Models\Review::query()->where('user_id',Auth::id())->where('type','profile')->orderBy('id','DESC')->get();
                @endphp
                @if (count($review)>0)
