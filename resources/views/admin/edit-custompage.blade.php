...
<div class="page-breadcrumb d-flex align-items-center mb-3" style="justify-content: space-between;">
   ...
   {{-- <button type="button" class="btn btn-dark btn-sm shadow-sm" onclick="editForm()">
      <i class="bx bx-edit m-0"></i> Edit Custom Page
   </button> --}}
</div>
@endsection
		...
		<div class="card">
			<div class="card-body position-relative">
				...
				<div class="col-lg-11 mx-auto">
                    <form method="post" class="row" action="{{route('admin.update-page')}}" id="add-college">
						@csrf
						<input type="hidden" name="id" value="{{$data->id}}">
						<div class="col-md-6 ">
							<div class="mb-3">
								<label for="link_text" class="form-label">Link Text</label>
								<input type="text" name="link_text" id="link_text" class="form-control"  value="{{ old('link_text', $data->link_text) }}" >
							</div>
						...
						<div class="col-12">
							<div class="mb-3">
								...
								<textarea type="text" name="description" id="description" class="form-control" style="height: 400px;">{{ old('description', $data->description) }}</textarea>
							</div>
						...
						<div class="col-12">
							<div class="mb-3">
								<button class="btn-primary btn mt-3" type="submit" >Update</button>
							</div>
						</div>
